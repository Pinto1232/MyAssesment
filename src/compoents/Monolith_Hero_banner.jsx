    ...
    return (
        ...
        >
            <div className='container mx-auto  sm:max-w-7xl  text-start'>
                <h3 className='text-tinyText m-5 sm:m-0 font-bold text-xl mb-2 mt-20 sm:mt-0'>Monolith</h3>
                <h2 className='text-5xl font-semibold text-white mb-4 sm:w-full w-[400px] m-5  sm:m-0 leading-[1.2]'>Test less. Learn more.</h2>
                <p className='text-white text-lg font-semibold  sm:w-[750px] leading-[1.9] m-5 sm:m-0 sm:mb-20'>Spend less time running expensive, repetitive tests and more time learning from your engineering data to predict the exact tests to run.</p>

                {/*button*/}
                <div className='container mx-auto cursor-pointer flex flex-col sm:flex-row gap-4 w-full mb-28 sm:mb-40'>
                    <div className='mb-10 m-5 sm:m-0'>
